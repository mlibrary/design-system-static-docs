...
const UniversalHeader = class {
  ...
  renderDropdown() {
    if (this.error) {
      return (index.h("p", { class: "m-uh__dropdown-error" }, index.h("strong", null, "Error"), ": We are temporarily having trouble loading our list of library sites. Please try refreshing your page. You can also contact ", index.h("a", { href: "https://www.lib.umich.edu/ask" }, "Ask a Librarian"), " ", "for help."));
    }
    if (this.content) {
      return [
        index.h("p", { class: "m-uh__heading" }, "Explore what the library has to offer."),
        index.h("ul", { class: "m-uh__list-primary" }, this.content.primary.map(item => (index.h("li", null, index.h("a", { href: item.link, class: "m-uh__item-link" }, index.h("span", { class: "m-uh__item-title" }, item.title), index.h("span", { class: "m-uh__item-desc" }, item.description)))))),
        index.h("ul", { class: "m-uh__list-secondary" }, this.content.secondary.map(item => (index.h("li", null, index.h("a", { href: item.link, class: "m-uh__item-link" }, index.h("span", { class: "m-uh__item-title" }, item.title))))))
      ];
    }
    return index.h("p", null, "Loading...");
  }
  render() {
    return [
      index.h("header", { class: "m-uh" }, index.h("div", { class: "m-uh__content" }, index.h("a", { class: "m-uh__link", href: "https://www.lib.umich.edu/" }, index.h("span", { class: "m-uh__link-text" }, "University of Michigan Library"), index.h("span", { class: "m-uh__link-text--small" }, index.h("abbr", { title: "University of Michigan" }, "U-M"), " Library")), index.h("div", { class: "m-uh__button-container" }, index.h("button", { class: "m-uh__button", "aria-expanded": String(this.open), onClick: () => this.toggle() }, index.h("span", { class: "m-uh__button-label" }, "Explore"), index.h("div", { "aria-hidden": "true", class: "m-uh__icons" }, this.open ? (index.h("m-icon", { name: "expand-less" })) : (index.h("m-icon", { name: "expand-more" })))), this.open && (index.h("div", { class: "m-uh__dropdown", ref: el => (this.dropdown = el) }, this.renderDropdown()))))),
      index.h("m-website-alerts", null)
    ];
  }
};
UniversalHeader.style = universalHeaderCss;

exports.m_universal_header = UniversalHeader;
