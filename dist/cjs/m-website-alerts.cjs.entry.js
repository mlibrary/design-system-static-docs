...
const WebsiteAlerts = class {
  ...
  render() {
    if (this.status === "success") {
      return (index.h("div", { class: "m-alerts", role: "alert" }, index.h("h2", { class: "m-alerts__heading" }, "Important message", this.alerts.length > 1 ? "s" : ""), this.alerts.map(alert => (index.h("div", { class: "m-alert" }, index.h("div", { class: "m-alert__content" }, index.h("m-icon", { name: "warning" }), index.h("div", { class: "m-alert__html", innerHTML: alert.html })))))));
    }
    return null;
  }
};
...
exports.m_website_alerts = WebsiteAlerts;
