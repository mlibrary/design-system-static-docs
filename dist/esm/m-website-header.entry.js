...
const WebsiteHeader = class {
  ...
  render() {
    ...
    return (h("header", { class: "website-header" + variant }, h("div", { class: "website-header__container" }, h("div", { class: "website-header__inner-container" }, h("div", { class: "website-header__logo-container" }, h("a", { href: "https://www.lib.umich.edu/", class: "website-header__lib-link" }, h("span", { class: "visually-hidden" }, "University of Michigan Library"), h("m-logo", { variant: logoVariant })), h("a", { href: this.to, class: "website-header__website-home-link" }, this.name && (h("span", { class: "website-header__website-name" }, this.name)))), h("slot", null)))));
  }
};
WebsiteHeader.style = websiteHeaderCss;

export { WebsiteHeader as m_website_header };
