...
<pre><code class="language-js">processor.process(opts).then(result =&gt; {
...
<pre><code class="language-js">processor.process(opts).catch(error =&gt; {
...
<pre><code class="language-js">result.warnings().forEach(warn =&gt; {
